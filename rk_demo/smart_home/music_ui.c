...
lv_obj_t *menu_music_init(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_radius(bg, 20, LV_PART_MAIN);
    lv_obj_set_style_clip_corner(bg, 1, LV_PART_MAIN);
    lv_obj_set_size(bg, lv_pct(90), lv_pct(60));
    ...
    lv_obj_set_flex_flow(area_player, LV_FLEX_FLOW_COLUMN);
    ...
    lv_obj_set_flex_align(area_label, LV_FLEX_ALIGN_CENTER,
    ...
    lv_obj_set_width(area_time, lv_pct(100));
    lv_obj_set_style_pad_all(area_time, 50, LV_PART_MAIN);

    slider = lv_slider_create(area_time);
    lv_obj_set_width(slider, lv_pct(100));
    lv_slider_set_range(slider, 0, 10000);
    lv_slider_set_value(slider, 0, LV_ANIM_OFF);
    lv_obj_align(slider, LV_ALIGN_CENTER, 0, 0);

    label_pos = lv_label_create(area_time);
    lv_obj_align(label_pos, LV_ALIGN_LEFT_MID, 0, 26);
    ...
    lv_obj_align(label_time, LV_ALIGN_RIGHT_MID, 0, 26);
